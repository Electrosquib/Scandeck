...
class ControlChannelScanDSP(gr.top_block):

    def __init__(self, freq=851e6, num_bins=2048, scan_idx=0):
        gr.top_block.__init__(self, "ControlChannelScan", catch_exceptions=True)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_float*num_bins, f"/home/scandeck-one/Scandeck/FFTs/{scan_idx}.bin", False)
    ...
    def set_scan_idx(self, scan_idx):
        self.scan_idx = scan_idx
...
def main(top_block_cls=ControlChannelScanDSP, options=None):
    if options is None:
